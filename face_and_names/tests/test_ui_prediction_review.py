...
def mock_context():
    ...
    conn.execute("CREATE TABLE person (id INTEGER PRIMARY KEY, primary_name TEXT, first_name TEXT, last_name TEXT, short_name TEXT, display_name TEXT, birthdate TEXT, notes TEXT)")
